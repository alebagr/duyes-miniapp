...
def profiles( x_telegram_init_data: str | None = Header(default=None), country: str | None = None, city: str | None = None, min_age: int | None = Query(default=None, ge=18, le=100), max_age: int | None = Query(default=None, ge=18, le=100), online: bool = False, ):
    uid = current_user(x_telegram_init_data)
    conn = db()
